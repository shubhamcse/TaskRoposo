...
public class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    protected List<StoryModel> stories;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        Glide.with(context).load(story.getSi()).fitCenter().placeholder(R.drawable.blank_profile_picture).crossFade().
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListViewHolder(View itemView) {
            ...
            mTextURL = (TextView) itemView.findViewById(R.id.text_view_url);
            mTextDescription = (TextView) itemView.findViewById(R.id.text_view_description);
            mTextURL.setVisibility(View.GONE);
            mTextDescription.setVisibility(View.GONE);
            mCardView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onItemClicked.onListItemClicked(getLayoutPosition(), v);
                }
            });
